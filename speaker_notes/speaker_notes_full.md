...
Now I move from forecasting quality to control impact. The simulator is COSCO: 50 heterogeneous hosts, sixty percent edge and forty percent cloud, with 3-millisecond edge latency, 76-millisecond cloud latency, and 5-gigabit links. The run lasts 2,000 control cycles at a 300-millisecond interval, with 50 containers and 4 arrivals per step.
